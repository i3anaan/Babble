...
/**
 * The visitor that constructs an AST tree from the tree generated by ANTLR
 * using our grammar rules.
 * 
 * For each visit*() method, a Node that represents the ANTLR rule is created,
 * along with all the children it needs to be an exact semantic copy of the
 * ANTLR rule.
 * 
 * visit() Is used to give each Node its location, in some cases (when having to
 * construct a Node from a TerminalNode) setLocation is directly called for the
 * Node.
 *
 */
public class ASTGenerator extends BabbleBaseVisitor<Node> {
    /** The file that was parsed by ANTLR. */
    ...
    public Node visitClazz(ClazzContext ctx) {
        ...
        if (ctx.superclass != null) {
            ...
            // By default a Babble class extends Object.
     ...
     * @param node Node for which to set the location.
     * @param tok ANTLR token that contains the necessary information.
     */
    ...
    /**
     * Convenience method to call visitExprArguments() with a single argument.
     */
    ...
    /**
     * Convenience method to quickly parse arguments.
     * This will visit the arguments.
     * @param arguments Arguments to parse
     * @return List of ExprNodes that represents the arguments.
     */
    ...
    /**
     * Convenience method to quickly parse declarations.
     * This will visit the declarations.
     * @param decls Declarations to parse
     * @return List of VarDeclNodes that represents the declarations.
     */
    ...
    /**
     * Convenience method to build a selector (signature, identifier) from a
     * list of TerminalNodes (the keywords).
     * @param list List of TerminalNodes to build the selector from
     * @return The selector.
     */
