...
public class BIntTest {
    ...
    @Test public void testEqEqTrue()    { assertEquals(Core.newTrue(), new BInt(10)._eqeq_(new BInt(10))); }
    @Test public void testEqEqFalse()   { assertEquals(Core.newFalse(), new BInt(10)._eqeq_(new BInt(15))); }

    @Test public void testBangEqTrue()  { assertEquals(Core.newFalse(), new BInt(10)._bangeq_(new BInt(10))); }
    @Test public void testBangEqFalse() { assertEquals(Core.newTrue(), new BInt(10)._bangeq_(new BInt(15))); }
    ...
    @Test public void testTenGtThree()  { assertEquals(Core.newTrue(), new BInt(10)._gt_(new BInt(3))); }
    @Test public void testThreeLtTen()  { assertEquals(Core.newTrue(), new BInt(3)._lt_(new BInt(10))); }

    @Test public void testTenGtEqTen()  { assertEquals(Core.newTrue(), new BInt(10)._gteq_(new BInt(10))); }
    @Test public void testTenGtEqOne()  { assertEquals(Core.newTrue(), new BInt(10)._gteq_(new BInt(1))); }
    @Test public void testTenLtEqOne()  { assertEquals(Core.newFalse(), new BInt(10)._lteq_(new BInt(1))); }
